...
# Forward-fix for GCC 16 / libstdc++ 16: the internal helper std::__throw_bad_alloc()
# (declared in <bits/functexcept.h>) was removed from the std namespace. jemalloc's C++
# shim already includes <new>, so the portable standard replacement is `throw std::bad_alloc()`.
# Without this, jemalloc_cpp.cpp fails to compile under Fedora 44's libstdc++ (clang uses it too).
vcpkg_replace_string("${SOURCE_PATH}/src/jemalloc_cpp.cpp"
