...
├── game/            T3   500 files   115,259 lines
...
flowchart TD
  ...
  subgraph T3["T3 simulation"]
    direction LR
    game["game<br/><small>500 files · 115,259 lines · Root×638</small>"]
  end
...
| T3 simulation | `game` | 500 | 115,259 | 48.3% |
