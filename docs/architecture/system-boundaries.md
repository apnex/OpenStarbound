...
├── game/            T3   500 files   115,411 lines
...
flowchart TD
  ...
  subgraph T3["T3 simulation"]
    direction LR
    game["game<br/><small>500 files · 115,411 lines · Root×639</small>"]
  end
...
| T3 simulation | `game` | 500 | 115,411 | 48.3% |
