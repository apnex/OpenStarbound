...
├── rendering/       T4    23 files     4,471 lines
...
flowchart TD
  ...
  subgraph T4["T4 presentation"]
    direction LR
    rendering["rendering<br/><small>23 files · 4,471 lines · Root×17</small>"]
...
| T4 presentation | `rendering` | 23 | 4,471 | 1.9% |
...
|:----------|------:|------:|:-----|-------------:|
| `rendering` | 23 | 4,471 | draws the WORLD — tiles, entities, lighting, parallax, sky | 24 includes in 12 files |
