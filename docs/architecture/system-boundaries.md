...
├── core/            T1   217 files    56,348 lines
...
├── application/     T2    25 files     7,489 lines
│   └── discord/         vendored — excluded from every count here
├── game/            T3   500 files   115,641 lines
...
├── test/            —     73 files    14,088 lines   ← outside the tier lattice; measured by nothing here
...
flowchart TD
  ...
  subgraph T1["T1 language"]
    direction LR
    core["core<br/><small>217 files · 56,348 lines · Root×0</small>"]
  end
  subgraph T2["T2 services"]
    ...
    application["application<br/><small>25 files · 7,489 lines · Root×0</small>"]
  end
  subgraph T3["T3 simulation"]
    direction LR
    game["game<br/><small>500 files · 115,641 lines · Root×640</small>"]
  end
  subgraph T4["T4 presentation"]
    direction LR
    rendering["rendering<br/><small>23 files · 4,588 lines · Root×17</small>"]
  ...
  subgraph T5["T5 shells"]
    direction LR
    client["client<br/><small>4 files · 2,591 lines · Root×2</small>"]
...
| T1 language | `core` | 217 | 56,348 | 23.5% |
| T2 services | `base` | 32 | 7,449 | 3.1% |
| T2 services | `metrics` | 7 | 847 | 0.4% |
| T2 services | `platform` | 4 | 142 | 0.1% |
| T2 services | `application` | 25 | 7,489 | 3.1% |
| T3 simulation | `game` | 500 | 115,641 | 48.3% |
| T4 presentation | `rendering` | 23 | 4,588 | 1.9% |
| T4 presentation | `windowing` | 61 | 9,646 | 4.0% |
| T4 presentation | `frontend` | 102 | 16,863 | 7.0% |
| T5 shells | `client` | 4 | 2,591 | 1.1% |
...
|:----------|------:|------:|:-----|-------------:|
| `rendering` | 23 | 4,588 | draws the WORLD — tiles, entities, lighting, parallax, sky | 24 includes in 12 files |
