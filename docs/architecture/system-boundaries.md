...
├── rendering/       T4    23 files     4,764 lines
...
├── test/            —     73 files    14,327 lines   ← outside the tier lattice; measured by nothing here
...
flowchart TD
  ...
  subgraph T2["T2 services"]
    direction LR
    base["base<br/><small>32 files · 7,472 lines · Root×0</small>"]
    metrics["metrics<br/><small>11 files · 1,423 lines · Root×0</small>"]
    platform["platform<br/><small>4 files · 142 lines · Root×0</small>"]
    application["application<br/><small>25 files · 7,677 lines · Root×0</small>"]
  end
  ...
  subgraph T4["T4 presentation"]
    direction LR
    rendering["rendering<br/><small>23 files · 4,764 lines · Root×17</small>"]
...
| T4 presentation | `rendering` | 23 | 4,764 | 2.0% |
...
xychart-beta
    ...
    bar [27, 3, 17, 14, 25, 33, 86, 8, 84, 12, 100, 50]
```
...
|:----------|------:|------:|:-----|-------------:|
| `rendering` | 23 | 4,764 | draws the WORLD — tiles, entities, lighting, parallax, sky | 24 includes in 12 files |
